...
void_t the_app::on_audio( motor::audio::frontend_ptr_t fptr, audio_data_in_t ad ) noexcept
{
    ...
    for( size_t i = 0; i < _aanl.captured_frequencies.size(); ++i )
    {
        ...
        {
            float_t const var =
                _aanl.captured_frequencies[ i ] - _aanl.captured_frequencies_avg[ i ];
...
// [2,3] : mid low frequencies
...
#endif
        { size_t( _aanl.asys.kick_start ), size_t( _aanl.asys.kick_start + _aanl.asys.kick_band ),
          300, 750 };
    ...
    // do threshold
    {
        ...
        _aanl.asys.is_kick = ( _aanl.asys.kick_history_single - 0.05f ) >
                             beat_threshold( kick_var ) * _aanl.asys.kick_average;
        _aanl.asys.is_lowm = ( _aanl.asys.midl_history_single - 0.005f ) >
                             beat_threshold( midl_var ) * _aanl.asys.midl_average;
    }
