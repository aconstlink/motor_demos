...
//*******************************************************************************
void_t scene_1::on_init( motor::io::database_ref_t db ) noexcept 
{
    ///////////////////////////////////////////////////////////////////////////////
    // Camera section
    ///////////////////////////////////////////////////////////////////////////////
    ...
    
    {
        // camera 1
        {
...

            {
                ...
                kfs_t kf ; 
                kf.insert( kfs_t::keyframe_t( 0, motor::math::vec3f_t( 5000, 0, 0 ) ) ) ;
                kf.insert( kfs_t::keyframe_t( 1000, motor::math::vec3f_t( 6000, 500, 80 ) ) ) ;
                kf.insert( kfs_t::keyframe_t( 3000, motor::math::vec3f_t( 5000, 800, 0 ) ) ) ;
...

            {
                using kfs_t = demos::camera_data::keyframe_sequencef_t ; 
                kfs_t kf ; 
                kf.insert( kfs_t::keyframe_t( 0, motor::math::vec3f_t( 0, -0, -0 ) ) ) ;
                kf.insert( kfs_t::keyframe_t( 1000, motor::math::vec3f_t( 0, -0, -0 ) ) ) ;
                kf.insert( kfs_t::keyframe_t( 3000, motor::math::vec3f_t( 0, 0, -0 ) ) ) ;
...
//*******************************************************************************
void_t scene_1::on_render_debug( bool_t const initial, motor::graphics::gen4::frontend_ptr_t fe ) noexcept
{
    
}

//*******************************************************************************
void_t scene_1::on_render_final( bool_t const initial, motor::graphics::gen4::frontend_ptr_t fe ) noexcept
{
