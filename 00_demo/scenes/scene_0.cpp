...
//*******************************************************************************
void_t scene_0::on_render_deinit( demos::iscene::render_mode const rm, motor::graphics::gen4::frontend_ptr_t ) noexcept 
{
    if ( rm == demos::iscene::render_mode::debug )
    {
    }
    else if ( rm == demos::iscene::render_mode::debug )
    {
    }
}
